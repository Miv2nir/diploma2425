<script>
    ...
    import FloatPointEvolModelForecast from "../function_forms/FloatPointEvolModelForecast.svelte";
    let {author,
      proj_obj,
      func_obj=$bindable(),
      ...
      ArchModelForecast,SplitByIndex,MergeDF,FloatPointEvolModelForecast};
      let FuncForm = $state();
      $effect(()=>{
